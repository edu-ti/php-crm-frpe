...
function handle_convert_lead_to_pre_proposal($pdo, $data) {
    ...
    try {
        ...
        // Adicionado cliente_pf_id na inserção
        $sql_insert_opp = "INSERT INTO oportunidades (titulo, cliente_pf_id, organizacao_id, contato_id, valor, etapa_id, usuario_id, comercial_user_id, pre_proposal_number, notas, descricao_produto, data_criacao, data_ultima_movimentacao) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())";
